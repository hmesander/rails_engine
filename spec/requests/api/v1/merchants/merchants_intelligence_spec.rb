...
describe 'Merchants API' do
  ...
  it 'sends top merchants based on most items sold' do
  ...
  it 'should return customers with pending invoices' do
    ...
    create_list(:transaction, 2, invoice: invoice2, result: 'failed')
    create(:transaction, invoice: invoice3, result: 'success')
    create_list(:transaction, 2, invoice: invoice3, result: 'failed')
  ...
  it 'should return the customer with the highest number of successful transactions' do
    ...
    expect(returned_customer['id']).to eq(customers[0].id)
  end
end
